...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Sync member info by mobile number.")
    parser.add_argument("--mobile", required=True, help="Member mobile number.")
...
def main() -> None:
    ...
    with SessionLocal() as session:
        ...
        result = sync_service.sync_member_by_mobile(args.mobile, commit=True)
